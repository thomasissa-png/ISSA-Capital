...
> Dernière mise à jour : 2026-05-13 (audit TTL session 14 — archivage S1-9 + condensation S10-13)
...
6. **@qa / testeurs persona** : les tests ne mesurent PAS la "conviction à soumettre". Ils mesurent la **perception de prestige**, la **crédibilité**, le **respect inspire**, la **clarté de l'identité**.
7. **@fullstack** : implementation soignée mais sans features de tracking de conversion agressives. Analytics Umami uniquement (cookieless, open source — décision Thomas session 9). Pas de heatmaps, pas de session recording.
...
- **GP7 "Conviction à s'inscrire"** → devient **"Respect inspire"** : "Après avoir vu le site, je respecte ISSA Capital et je comprends pourquoi elle existe" — pas besoin que le testeur veuille remplir un formulaire
...
- **Capital social** : **1 047 562,00 EUR** (confirmé Thomas 2026-04-07)
...
> **RÈGLE ABSOLUE — A LIRE PAR TOUS LES AGENTS** : la famille Issa est **LIBANAISE**. ISSA Capital est une SAS française (siège Nanterre 92), mais la famille fondatrice est libanaise. Cette double identité libano-française est un **asset différenciant** à valoriser, pas à masquer.
...
- **Rôle familial** : "a su prendre soin de ses deux enfants" (Thomas a donc un frère ou une soeur — **information à usage interne uniquement**, ne pas exposer publiquement sauf validation Thomas)
...
- **À valider avec Thomas** : accepte-t-il de citer Sonia par son nom sur le site ? Recommandation orchestrator : oui pour la page Mission (enrichit l'histoire), avec parcimonie (pas de date de naissance publique pour respect vie privée).
...
- **Antoine Issa** — né le **4 avril 2015**
- **Noemie Issa** — née le **18 decembre 2018**
- **Lucas Issa** — né le ** mars 2023**

**Arc générationnel complet de la holding** : Jean-Pierre Issa (1958, Dakar → Liban → IBM → Lexmark → patrimoine immo Paris/Normandie/Liban) **→** Thomas Issa (Paris, Sony/TEOS/advisor/agence com → création ISSA Capital 2026) **→** Antoine + Noemie + Lucas (2015, 2018, 2023 — bénéficiaires de la transmission).

**Usage copy — données personnelles mineures** :
...
- **Validations Thomas 2026-04-07** :
  1. Nommer Jean-Pierre Issa publiquement : **VALIDE**
  2. Mentionner IBM et Lexmark : **VALIDE** ("pas de problème pour citer les sociétés")
  ...
  5. Terrains Liban : formulation générique acceptable (pas de details publics)
...
- **Siège** : 12 rue du Galus, 33700 Mérignac (agglomeration bordelaise)
...
- **Produits phares distribues** : LabStar 330S, LabStar 330HD, DigiCoat 3D, Digital Ultra, tetes d'impression Graph-Tech USA, Stelvio BSA
...
- **Présence internationale** (réelle et étendue) :
  - **Europe** : France, Espagne, Belgique, Malte + support Italie, Allemagne, Grece
  - **Afrique** : Algerie, Maroc, Tunisie, Sénégal, Kenya, Ethiopie
  - **Ameriques** : Canada, Paraguay, Uruguay, Chili, Argentine, Bresil
...
- **Pertinence brand-story CRITIQUE pour ISSA Capital** :
  1. **Track record tangible** : une société française familiale, active depuis 1994, 4 M EUR CA, 17 pays, rentable, internationalisée avec succès. C'est exactement le modèle qu'ISSA Capital incarne à l'échelle holding.
...
- **Usage copy — décision orchestrator (Thomas a délégué le choix a l'équipe)** :
...
- **Implication pour les agents** :
  ...
  - @copywriter : ne JAMAIS écrire "famille française" NI "famille libanaise" (retour Jean-Pierre session 9). Formulations autorisees : "famille Issa", "famille aux racines libanaises", "d'origine libanaise" (bio uniquement), "héritage libanais"
...
- **Precision identitaire #2 (ajoutée Thomas 2026-04-07, RENFORCÉE par Jean-Pierre 2026-04-09)** : **NE PLUS ÉCRIRE "famille libanaise"** nulle part dans les livrables client-facing. Retour Jean-Pierre Issa : *"On n'est pas tout a fait libanais comme on n'a pas tous la nationalité même si on vient du Liban... Gardons la tagline avec racines, mais enlevons quand on peut enlever, et reformulons sinon pour ne pas dire famille libanaise."*
- **Formulations AUTORISEES** : "racines libanaises" (tagline OK), "d'origine libanaise" (factuel, bio Jean-Pierre/Sonia), "héritage libanais" (culturel), "famille Issa" (neutre), "famille aux racines libanaises" (nuance)
- **Formulations INTERDITES** : "famille libanaise" (présuppose la nationalité), "famille française" (anti-règle #1 inchangee)
- **Exception narrative restreinte** : "dans une famille d'origine libanaise" autorise UNIQUEMENT dans les bios passees de Jean-Pierre et Sonia (fait historique). Jamais "famille libanaise" sans "d'origine".
- **Règle copywriter mise à jour session 9** :
  ...
  - **Bio Jean-Pierre/Sonia** → "d'origine libanaise" autorise (factuel, passe)
  - **Registre poétique/éditorial** → "héritage libanais", "racines libanaises" autorise

---

## Écosystème de participations (a présenter sur le site)

**Ordre d'affichage souhaite sur le site** : Gradient One → Versi Immobilier → Versi Invest → Immocrew → Versimo → Immobilier en direct
**Participation a mettre en avant comme vitrine** : aucune en particulier — traitement equilibre
...
- **These ISSA** : projets entrepreneuriaux et immobiliers
...
- **URL** : versi-immobilier.fr (site **bientot prêt**, pas encore en ligne)
...
- **Note copy** : si site live au lancement → lien sortant ; sinon mention "site bientot disponible"
...
- **ATTENTION LEGAL** : "club deal" et "conseil en achat immobilier" doivent être présentés avec prudence pour éviter qualification d'offre au public de titres financiers / démarchage financier (cf. legal-audit.md liste noire). À valider par @copywriter + @legal avant publication.
...
- **Pricing** : 100 EUR/mois (annuel) ou 150 EUR/mois
...
- **Pricing** : Découverte gratuit (2 visuels) / Starter 9,90 EUR (15 visuels) / Pro 29 EUR/mois (50 visuels)
- **Cibles** : architectes d'intérieur, marchands de biens, particuliers exigeants
- **Headline site** : "Votre piece meublée, en 90 secondes."
...
- **Sony Professional Solutions Europe** (14 ans 11 mois, 2011 → aujourd'hui)
  ...
  - **Corporate & Éducation Solutions Manager Europe** (avril 2018 →) : BRAVIA Professional displays **+500 % de croissance depuis 2013**, leadership équipes France/UK.
...
- **Altran Technologies** (2008-2009) — Strategic Marketing Analyst : analyses pays européens, secteurs Aerospace/Defense/Automotive/Énergie/Santé/Telecom, intelligence concurrentielle Global Accounts.
...
### Distinctions
- **Major de promotion x 3** (Liste du Président + 2 Majors de promotion)
- **Exceptional Contribution Award x 2** (Sony)
...
2. **Intrapreneuriat & zéro-a-un dans un corporate** — TEOS from 10-slide deck to 6000 % ROI en 1 an
...
### Asset de crédibilité CONFIDENTIEL — NON publiable au lancement
Thomas a **créé une agence de communication** à partir de **1 500 EUR de fonds propres**, atteint **3,4 M EUR de CA**, et **revendue pour 2 M EUR**.
...
- **Déclencheur de republication** : quand Thomas signale que la restriction est levée, @copywriter et @seo DOIVENT l'intégrer en priorité sur la page Mission de conseil — c'est un asset de crédibilité majeur (exit à 2 M EUR from 1 500 EUR, bootstrap pur, track record chiffre)
...
- **Pas d'opportunités sous seuil de ticket minimum** — proposition : 200 k EUR mini pour l'immo (aligné Leila), à valider
...
→ **VALIDÉS en bloc par Thomas le 2026-04-07.** À assumer publiquement sur la page /accompagnement et /opportunités.
...
**Aucune phrase spécifique** obligatoire ou interdite au niveau du fondateur. Liberté laissée à @copywriter dans le cadre du ton "caractère/fier" et des règles globales (vocabulaire prescrit/proscrit brand-platform, anti-L.411-1 CMF liste noire légal).

---

## Cible (validés session 4, verrouillés par Thomas)
- **Persona principal A — Karim** (42 ans, entrepreneur en structuration patrimoniale) — cible CTA "Mission de conseil & accompagnement". Frustration : "Je gère plusieurs structures mais personne pour m'aider à structurer mon patrimoine avec une vision long-terme."
- **Persona principal B — Leila** (38 ans, apporteur d'affaires immo / fondateur cherchant co-investisseur) — cible CTA "Proposer une opportunité d'affaires". Frustration : "Je cherche un co-investisseur long-terme, pas un fonds qui sort dans 5 ans."
- **Persona secondaire — Marc** (38 ans, journaliste/analyste économique) — earned media & crédibilité institutionnelle
- **Problème principal** : absence de holding patrimoniale française lisible, à dimension humaine forte, qui s'engage long-terme avec des valeurs non négociables
- **Alternative actuelle** : LinkedIn de Thomas Issa, recherches Google fragmentaires, fonds LBO traditionnels
- **Personas supprimés** : Helene + Sophie (scope business incompatible — ISSA ne fait pas de cession PME, cf. lessons-learned session 4)
...
- **Ton de marque** : premium élégant, sobre, intemporel, éditorial. Pas de tape-à-l'oeil. Référence : maisons de gestion patrimoniale haut de gamme, holdings familiales européennes type Agache / Artemis / Berkshire (texte minimaliste)
- **3 mots qui DÉFINISSENT la marque** : Famille — Transmission — Long-terme
- **3 mots qui ne DÉFINISSENT PAS la marque** : Spéculatif — Tape-à-l'oeil — Court-termiste
- **Concurrents / holdings de référence** : Agache, Artemis (Pinault), Mulliez (AFM), Peugeot Invest, Otium Capital (Sterin), Eurazeo (dans une moindre mesure). Toutes holdings familiales européennes — à benchmarker par @creative-strategy en Phase 0 (competitive-benchmark.md)
- **Notre différence clé** : [HYPOTHESE H4 — corrigée] — holding 100% familiale assumée + horizon intergénérationnel (pas de fonds à terme) + filtres de décision non négociables (éthique humaine, environnement) + écosystème tech/immo intégré (Gradient, Versi, Immocrew, Versimo)
...
- **KPI North Star** : [HYPOTHESE — à formaliser par @data-analyst en Phase 0]
  ...
  - Qualitatif : perception de crédibilité institutionnelle (mesurée via 3-5 retours qualitatifs de partenaires sollicites après le lancement)
...
## Contraintes
- **Budget mensuel infrastructure** : minimal (Replit + domaine + Resend ou équivalent) — cible <30 EUR/mois
- **Budget mensuel acquisition** : 0 EUR (pas d'ads — c'est un site institutionnel, pas un funnel commercial)
- **Budget analytics** : 0 EUR (Plausible self-hosted ou plan minimal, ou GA4 gratuit)
- **Budget photo/video** : **0 EUR** — direction obligatoire pour @design : construire le premium élégant sur la TYPO + l'ESPACE BLANC + l'ÉDITORIAL + des illustrations / patterns / images libres très sélectionnées (Unsplash haut de gamme) ou génération IA si pertinente. PAS de shooting pro
- **Budget copy** : 0 EUR — 100% délégué à @copywriter
...
- **Comptes sociaux existants** : [A COMPLÉTER par Thomas si pertinents — LinkedIn personnel Thomas Issa, LinkedIn société à confirmer]
...
4. **Opportunités d'investissement** — critères d'investissement, secteurs cibles, ce qu'ISSA recherche / refuse, formulaire de proposition
...
| fullstack (S14) | 2026-05-13 | vault-client/ (7 modules + 6 test files, 81 tests), docs/dev-decisions.md (env vars + archi) | Jalon 0+1 email-ingest : vault-client complet. Parser frontmatter natif (bit-perfect, zéro gray-matter). Drive resolver cache TTL 1h. Write-lock par path. Audit trail JSONL. Chrono inverse append. findContactByEmail multi-dossiers. | gray-matter écarté (re-sérialise YAML = casse frontmatter). Mutualisation getAccessToken() de drive-upload.ts. |
| fullstack (S14) | 2026-05-13 | gmail-source/ (4 modules + 3 test files, 49 tests), triage/ (3 modules + 2 test files, 52 tests), drive-auth (scopes Gmail), ingest-gmail CLI, 20 fixtures eval | Jalon 2+3 email-ingest : Gmail source complet (client, label-resolver cache 1h, listing+filtre local). Triage Haiku 4.5 complet (prompt versionné, Zod, retry, override confidence <0.7). OAuth étendu 5 scopes. Matrice confusion 20 fixtures : 100%/100%. | Mutualisation getAccessToken(). Label-resolver même pattern que drive-resolver. Haiku 4.5 (pas Sonnet) pour triage. |
| fullstack (S14) | 2026-05-13 | handlers/ (4A, 4 handlers + types, 40 tests), telegram-validation/ (4B, cards+pending-store+callback, 46 tests) | Jalon 4A+4B email-ingest : handlers par catégorie (locataire, contact-pro, apporteur, a-classifier). Pending-store sur Drive (pas FS Replit). Callback-handler (valider/skip/voir/modifier). Cards HTML Telegram. | ActionProposal[] jamais exécuté directement — validation Telegram obligatoire. Drive > FS Replit (éphémère). |
| fullstack (S14) | 2026-05-14 | email-ingest/ (4C runner+prefilter+cache, 49 tests), api/secretariat/email-ingest (6 tests), webhook dispatch (1 test), docs, .env.example | Jalon 4C email-ingest V1 COMPLÈTE : pipeline runEmailIngest(), pré-filtre heuristique (~70% économie Haiku), contacts cache 1h, endpoint POST /api/secretariat/email-ingest, dispatch webhook email_val:. Fix regex sendgrid/mailgun. 856 tests total. | V1 email-ingest livrée. Pré-filtre avant Haiku = économie tokens. Auto-spam Haiku confidence >0.9. "Modifier" hors scope V1. |
...
|-------|------|----------|-------|-------|
| reviewer | 2026-04-07 | cross-review-report.md (32 gates Phase 3) | 9.5/10 | GO CONDITIONNEL — 2 FAIL BLOQUANT (G7 copy/code, G15 unicode), corrigés. Audit page-par-page : 6 GO + 1 GO CONDITIONNEL. |
...
- **Supprimés** : Helene + Sophie (scope business incompatible — cf. lessons-learned.md)
...
- **Hero** (page Accueil) : RETIRÉE post-deploy sur ordre Thomas — antithèse défensive. Remplacée par la baseline canonique. **Une seule tagline, répétée hero + footer. Ne jamais reproposer une alternative hero.**
...
**Aucun pricing affiché sur le site.** Pas de "sur devis" explicite non plus — plus premium de ne rien mentionner et d'amener directement au formulaire de contact.
...
Checkpoint Phase 0 stratégique : Thomas a tranché toutes les hypothèses.

| # | Hypothèse | Décision Thomas | Statut |
|---|---|---|---|
| H1 | Persona principal = fondateur de PME (Helene) plutôt que journaliste ou partenaire B2B | OK | **VALIDÉE** |
...
| H4 | Difference clé : holding 100% familiale assumée + horizon intergénérationnel + filtres non négociables + écosystème tech/immo | "essayons" (OK pour tester) | **VALIDÉE** |
...
Les mémos de reprise des sessions 5, 6, 7, 9, 10 et 11 ont été archivés dans `docs/project-context-archive.md` (clôture session 11, 2026-05-12). Consulter ce fichier pour l'historique détaillé. Le mémo actif est celui de la session courante uniquement.
...
- **Clause pénale 3x loyer journalier** : arbitrage Thomas attendu (3x dissuasif réductible vs 1x défendable).
...
2. **Tester `inbox-message-router` vocal** : envoie un message vocal Telegram en mode inbox → Whisper transcrit → Haiku extrait → carte preview. Pre-requis : `OPENAI_API_KEY` dans Replit Secrets.
3. **Tester `inbox-photo-batch`** : envoie 3-4 photos en mode fichier → Anya bufferise 5s → demande la date → reponds "1" → upload avec date du jour. Vérifier nom de fichier dans `_Inbox/Photos/`.
4. **Décisions à fournir avant relance @fullstack sur le bail** (INCHANGÉ depuis S12) :
   - Encadrement loyers — valeurs EUR/m2 Nanterre + Paris 18
   - Arbitrage IRL : API INSEE auto OU saisie manuelle trimestrielle ?
   - Arbitrage clause pénale : 3x ou 1x loyer journalier ?
...
- **Photos HEIC** : abandon extraction EXIF (Telegram iOS strip systématiquement). Workflow `inbox-photo-batch` demande la date a Thomas via boutons. Fenêtre 5s (8s trop long).
...
- **Voice transcription** : OpenAI Whisper retenu (Google STT impose billing account même en free tier). Coût ~0,03 EUR/mois.
...
### Prochaines actions recommandées S15 (ordre)

1. **Propager les 7 P2 restants** de lessons-learned.md (S12+S13) — non bloquants mais à faire quand le temps le permet.
2. **Après inputs Thomas sur bail** : @fullstack applique P0 bail #2 + #3 + 2 P1 quittance/fin-de-bail (~1h30).
3. **Phase 6 promotion candidat → locataire** (~30 min @fullstack).
4. **Helper extractPdfText partage** (~10 min).
5. **Email-ingest Phase 1A Gmail** si bande passante (~6-7h, plan prêt dans `second-cerveau/Anya - Plan email-ingest.md`).
...
- ~~Caps fichiers framework dépassés~~ — **RÉSOLU S14** : audit TTL terminé, tous les fichiers sous leurs caps.

### Commande de reprise S15

```
@orchestrator Mode reprise de session ISSA Capital — Session 15. Branche : à définir. Lis project-context.md (mémo session 15) + docs/lessons-learned.md (7 P2 à-faire). Priorités : (1) Propager 7 P2 restants (S12+S13). (2) Après inputs Thomas sur bail : @fullstack applique P0 bail #2 + #3 + 2 P1. (3) Phase 6 promotion candidat → locataire. (4) Helper extractPdfText partagé. (5) Email-ingest Phase 1A Gmail si bande passante.
```
