  ...
  return (
    <Section tone="default" className="py-5xl">
      <Container width="editorial" className="text-center">
        <p className="overline text-levant-600">Erreur 404</p>
        ...
        <div className="mt-xl flex flex-wrap justify-center gap-lg text-sm">
          <Link href="/mission" className="text-levant-600 hover:text-levant-700">
            Mission
          </Link>
          <Link href="/participations" className="text-levant-600 hover:text-levant-700">
            Participations
          </Link>
          <Link href="/contact" className="text-levant-600 hover:text-levant-700">
            Contact
          </Link>
        </div>
      </Container>
