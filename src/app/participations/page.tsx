 ...
 *   2. Accompagnement et co-investissement — Versi Invest + Immocrew
 *   3. Technologie au service de l'immobilier — Versimo
...
export const metadata: Metadata = {
  ...
  description:
    "L'écosystème immobilier d'ISSA Capital construit depuis 2020 : Patrimoine résidentiel IDF, Versi Immobilier, Versi Invest, Immocrew, Versimo.",
  ...
  return (
    <>
        ...
        <Container width="content">
          ...
          <div className="mt-lg max-w-[800px]">
            ...
            <p className="mt-md text-xs italic text-ink-500">
              Gradient One est la holding intermédiaire co-fondée par ISSA Capital
              en 2020. Elle détient les participations opérationnelles et
              financières de l&apos;écosystème. Les actifs immobiliers
              résidentiels sont détenus directement par ISSA Capital.
            </p>
            <p className="mt-md text-base text-ink-600">
              Cette page présente la cartographie complète des participations et
              actifs d&apos;ISSA Capital.
            </p>
          </div>
        </Container>
      </Section>
      ...
      {/* Section 2 — Accompagnement et co-investissement.
          2 blocs : Versi Invest + Immocrew. Versi Invest description simplifiée
          (1 phrase unique — verrouillage session 6 CHECKPOINT #3). Aucun
          traitement featured (bordure renforcée, colonne élargie) supprimé. */}
      <Section tone="subtle">
        <Container width="content">
          <div className="mb-2xl max-w-editorial">
      ...
      {/* Section 3 — Technologie au service de l'immobilier.
          1 bloc unique : Versimo (home staging virtuel par IA). */}
      <Section tone="default">
        <Container width="content">
          <div className="mb-2xl max-w-editorial">
            ...
            <p className="mt-md text-lead text-ink-700">
              Une participation de l&apos;écosystème développe des outils
              numériques pour les professionnels du secteur.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-xl md:grid-cols-2">
            {/* Bloc — Versimo */}
